...
test('renders title and author', () => {
	...
	render(<Blog blog={blog} handleLike={handleLike} handleRemove={handleRemove} user={user}/>)
...
test('renders all after click', async () => {
	...
	render(<Blog blog={blog} handleLike={mockHandleLike} handleRemove={mockHandleRemove} user={mockUser}/>)
