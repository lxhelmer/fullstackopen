...
sequenceDiagram
	...
	Note right to browser: like when normally loading the site after the data.json is returned with code 200(OK)
	the notes are rendered from the data.json to the site.
